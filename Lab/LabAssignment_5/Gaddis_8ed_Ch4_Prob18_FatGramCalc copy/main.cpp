...
{
    //Declare Variables    ****changed Double to float 
        float pcntCal, //Percent Calories of Fat (%)
            gramFat, //Grams of Fat in Food (g)
            calsFat, //Calories from Fat (Cal)
            totCals; //Total Amount of Calories in Food (Cal)
